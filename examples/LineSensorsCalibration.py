...
print "Put the robot on a Yellow surface"
time.sleep(4)                           
...
print "On Yellow ", Luno, L2, L3, L4
Luno = 0
L2 = 0
L3 = 0
L4 = 0
print "Put the robot on a Blue surface"
time.sleep(4)                           
for i in range(0, 10):
    line_sensors = gianopirobot.get_ground_sensors(list)
    Luno = Luno + line_sensors[0] 
...
print "On Blue ", Luno, L2, L3, L4   
Luno = 0
L2 = 0
L3 = 0
L4 = 0

print "Put the robot on a Green surface"
time.sleep(4)                           
for i in range(0, 10):
    line_sensors = gianopirobot.get_ground_sensors(list)
    Luno = Luno + line_sensors[0] 
...
print "On Green ", Luno, L2, L3, L4
Luno = 0
L2 = 0
L3 = 0
L4 = 0
print "Put the robot on a Brown surface"
time.sleep(4)                           
for i in range(0, 10):
    line_sensors = gianopirobot.get_ground_sensors(list)
    Luno = Luno + line_sensors[0] 
...
L3 = 0
L4 = 0
print "Put the robot on a Red surface"
time.sleep(4)                           
for i in range(0, 10):
    line_sensors = gianopirobot.get_ground_sensors(list)
    Luno = Luno + line_sensors[0] 

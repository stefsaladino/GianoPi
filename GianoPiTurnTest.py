...
#                     forever.
gianopirobot.turnleft_m2_m4(150, 1.0)   # turn left at speed 150 for 1 second.
...
gianopirobot.turnleft_m2_m4(200, 0.5)      # turn left at speed 200 for 0.5 seconds.
time.sleep(2.0)   # Pause for a few seconds while the robot spins (you could do
                  # other processing here though!).
gianopirobot.stop()      # Stop the robot from moving.

gianopirobot.turnright_m2_m4(150, 1.0)   # turn left at speed 150 for 1 second.
time.sleep(2.0)   # Pause for a few seconds while the robot spins (you could do
                  # other processing here though!).
gianopirobot.stop()      # Stop the robot from moving.

gianopirobot.turnright_m2_m4(200, 0.5)      # turn left at speed 200 for 0.5 seconds.
time.sleep(2.0)   # Pause for a few seconds while the robot spins (you could do
                  # other processing here though!).
gianopirobot.stop()      # Stop the robot from moving.

gianopirobot.turnleft_m1_m3(150, 1.0)   # turn left at speed 150 for 1 second.
time.sleep(2.0)   # Pause for a few seconds while the robot spins (you could do
                  # other processing here though!).
gianopirobot.stop()      # Stop the robot from moving.

gianopirobot.turnleft_m1_m3(200, 0.5)      # turn left at speed 200 for 0.5 seconds.
time.sleep(2.0)   # Pause for a few seconds while the robot spins (you could do
                  # other processing here though!).
gianopirobot.stop()      # Stop the robot from moving.

gianopirobot.turnright_m1_m3(150, 1.0)   # turn left at speed 150 for 1 second.
time.sleep(2.0)   # Pause for a few seconds while the robot spins (you could do
                  # other processing here though!).
gianopirobot.stop()      # Stop the robot from moving.

gianopirobot.turnright_m1_m3(200, 0.5)      # turn left at speed 200 for 0.5 seconds.
time.sleep(2.0)   # Pause for a few seconds while the robot spins (you could do
                  # other processing here though!).
gianopirobot.stop()      # Stop the robot from moving.
